...
class HuggingFaceService(AIService):
    ...
    def add_generated_tags(self, article: Article) -> tuple[list[Tag], list[Topic], list[TopicLabel], list[Label]]:
        ...
        #         'message': {
        #             'content': [
        #                 {'topic': 'Cobalt Strike usage by adversaries', 'labels': ['Cobalt Strike', 'RiskIQ']},
        #                 {'topic': 'Microsoft', 'labels': ['Microsoft technologies', 'RiskIQ']},
        #             ]
        #         }
        #     }]
        # })
    ...
    def _get_tagging_prompt(self, summary_text: str) -> str:
