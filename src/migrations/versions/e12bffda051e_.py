...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=100), nullable=False),
        sa.Column(
            "is_global", sa.Boolean(), server_default=sa.text("1"), nullable=False
        ),
        sa.Column("enabled", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "following", sa.Boolean(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column("notes", sa.Text(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("similarity", sa.Numeric(precision=10, scale=10), nullable=True),
        sa.Column(
            "manually_set", sa.Boolean(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.ForeignKeyConstraint(
            ["followup_article_id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "weight",
            sa.Numeric(precision=10, scale=10),
